const format = new class Format {
    ...
    avatar(img) {
        return '<img style="border-radius:25%;width: 18px;height: 18px;" class="render-image" src="' + img + '" onerror="this.src=\'/favicon.ico\';this.onerror=null;">';
    }
    ...
    item(item) {
        return `<span class="table-item"><img src="${item?.cover}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${item?.name}</span></span>`;
    }
    ...
    category(item, obj = null) {
        ...
        return `<span class="table-item table-item-cate"><img src="${item?.icon}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${item?.name}</span></span>`;
    }
    ...
    group(group) {
        ...
        return `<span class="table-item table-item-cate"><img src="${group.icon}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${group.name}</span></span>`;
    }
    ...
    user(item) {
        ...
        return `<span class="table-item table-item-user"><img src="${item.avatar}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${item.username}</span></span>`;
    }
    ...
    shared(item) {
        ...
        return `<span class="table-item table-item-user"><img src="${item.domain}/favicon.ico" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${item.name}</span></span>`;
    }
    ...
    bank(item) {
        ...
        return `<span class="table-item"><img src="${item.icon}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${item.name}</span></span>`;
    }
    ...
    site(item) {
        ...
        return `<span class="table-item"><img src="${item.logo}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${item.title}</span></span>`;
    }
    ...
    pay(item) {
        ...
        return `<span class="pay-item"><img src="${item.icon}" class="item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="item-name">${item.name}</span></span>`;
    }
    ...
    bankCard(item) {
        ...
        return `<span class="table-item"><img src="${item?.bank?.icon}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${item?.bank?.name}(${item.card_no})</span></span>`;
    }
    ...
    select2BankCard(state) {
        ...
        var $state = $(
            `<span class="select2-item"><img src="${state.element.getAttribute('data-icon')}" class="table-item-icon" onerror="this.src='/favicon.ico';this.onerror=null;"><span class="table-item-name">${state.text}</span></span>`
        );
        return $state;
    }
