!function () {
    let _substation_display_list_raw = getVar("_substation_display_list");
    let _substation_display_list;
    try {
        _substation_display_list = _substation_display_list_raw ? JSON.parse(_substation_display_list_raw) : [];
    } catch (e) {
        _substation_display_list = [];
    }
